...
function renderStaff(data) {
    ...
    document.getElementById('tableHTML').innerHTML = staffHTML;
...
function searchStaff() {
    ...
    var keyWord = removeCharacters(document.getElementById('searchName').value);
...
function getUpdateStaff(staffAccount) {
    ...
    document.getElementById('workingTime').value = staff.workingTime;
...
function requied(value, tagId, text) {
    var show = document.getElementById(tagId);
    if (value.length === 0) {
